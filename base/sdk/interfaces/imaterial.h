...
public:
	...
	virtual EPreviewImageRetVal    GetPreviewImageProperties( int* width, int* height, EImageFormat* imageFormat, bool* isTranslucent ) const = 0;
	virtual EPreviewImageRetVal    GetPreviewImage( unsigned char* data, int width, int height, EImageFormat imageFormat ) const = 0;
